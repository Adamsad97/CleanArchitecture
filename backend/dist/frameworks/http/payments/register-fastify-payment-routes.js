...
function sendFastifyPaymentVerificationResponse(reply, deps, payload) {
    const verificationResult = verifyPayment({ ids: deps.ids }, payload);
...
export function registerFastifyPaymentRoutes(app, deps) {
